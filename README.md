# [SOLVED] Adding-Information-To-An-Exception
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/adding-information-to-an-exception)
>
...
Use the `raise` keyword with a custom exception class or create a wrapper function to modify the exception message.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/adding-information-to-an-exception)**
